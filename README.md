Este proyecto es una aplicación de lista de tareas (TO-DO LIST) desarrollada en Java. Permite a los usuarios gestionar sus pendientes de manera eficiente mediante una interfaz gráfica intuitiva.
